...
def test__heat_driven_cavity(tmpdir):
    ...
    sim.solution = sim.solve_with_rayleigh_number_continuation()
    ...
    tests.validation.helpers.check_scalar_solution_component(
        ...
        expected_values=[val*Ra**0.5/Pr for val in (0.0000, -0.0649, -0.0194, 0.0000, 0.0194, 0.0649)],
        absolute_tolerances=[val*Ra**0.5/Pr for val in (1.e-12, 0.001, 0.001, 1.e-12, 0.001, 0.001)])
