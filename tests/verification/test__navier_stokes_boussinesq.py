...
def strong_residual(sim, solution):
    ...
    Re = sim.form_parameters.reynolds_number

    Pr = sim.form_parameters.prandtl_number
...
def dirichlet_boundary_conditions(sim):
    ...
    """
    _, u, T = manufactured_solution(sim)

    return [
        fe.DirichletBC(sim.mixed_helpers.solution_subspaces.u, u, "on_boundary"),
        fe.DirichletBC(sim.mixed_helpers.solution_subspaces.T, T, "on_boundary")]
