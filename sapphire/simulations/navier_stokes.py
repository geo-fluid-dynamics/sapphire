...
class Simulation(sapphire.simulation.Simulation):
    ...
    def __init__(
        ...
        sapphire.simulation.Simulation.__init__(self, *args, fieldnames=("p", "u"), **kwargs)
    ...
    def momentum(self):
        ...
        return (dot(psi_u, grad(u)*u) - div(psi_u)*p + 2./Re*inner(sym(grad(psi_u)), sym(grad(u))))*self.dx
    ...
    def solve(self):
        ...
        self.solution = sapphire.simulation.Simulation.solve(self)
